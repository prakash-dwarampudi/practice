 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://sample.com/", wsdlLocation = "http://localhost:8080/sample/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://sample.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sample/hello?wsdl");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://sample.com/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sample.com/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }
